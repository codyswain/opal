...
throwaway user-data directory, database and temp vault. They are evidence
...
Build first (both rebuild better-sqlite3 for Electron and produce `.vite/build`):
...
Run `npm test` afterwards if you need the Node build of better-sqlite3 back.
